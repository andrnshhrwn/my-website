...
const MainLayout = () => {
  ...
  return (
    <div className="relative text-slate-400 bg-[#020618] h-screen flex justify-center items-center overflow-hidden">
      ...
      <div
        className={`absolute min-md:inset-2 min-lg:inset-3 max-md:inset-1 rounded-lg bg-[rgba(15,23,43,0.5)] border transition-all duration-300 backdrop-blur-2xl overflow-hidden ${
          isOpen ? "border-transparent" : "border-slate-700"
        }`}
      >
